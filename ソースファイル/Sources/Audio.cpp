...
void AudioManager::SetUp() {
	...
	// 音量設定
	ChangeVolumeSoundMem(200, se[BUTTON_MOVE]);
	ChangeVolumeSoundMem(200, se[BUTTON_BEEP]);
	ChangeVolumeSoundMem(200, se[BUTTON_SELECT]);
	ChangeVolumeSoundMem(100, se[JINGLE_CLEAR]);
